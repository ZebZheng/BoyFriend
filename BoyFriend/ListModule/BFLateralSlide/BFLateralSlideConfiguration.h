...
typedef NS_ENUM(NSUInteger,BFDrawerTransitionDirection) {
    BFDrawerTransitionFromLeft = 0, // 左侧滑出
    BFDrawerTransitionFromRight     // 右侧滑出
};

@interface BFLateralSlideConfiguration : NSObject
