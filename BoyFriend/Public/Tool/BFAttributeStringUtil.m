...
#import "BFAttributeStringUtil.h"

@implementation BFAttributeStringUtil
...
+(NSDictionary*)attributeWithColor:(UIColor*)color
                        lineHeight:(CGFloat)lineHeight
                              font:(UIFont*)font{
    return [self attributeWithColor:color lineHeight:lineHeight font:font baseLine:0];
}
...
+(NSDictionary*)attributeWithColor:(UIColor*)color
    ...
    [dict setObject:@(offset) forKey:NSBaselineOffsetAttributeName];
