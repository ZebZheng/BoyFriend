...
#pragma mark - 链式属性实现
- (BFConrnerCorner)bf_conrnerCorner {
...
- (BFConrnerRadius)bf_conrnerRadius {
...
- (BFShadowOpacity)bf_shadowOpacity {
...
- (BFShadowRadius)bf_shadowRadius {
    return ^(CGFloat radius) {
...
- (BFShadowOffset)bf_shadowOffset {
    return ^(CGSize size) {
