//
//  UIImageView+BFAddition.m
//
//  Created by BF on 2021
//

#import "UIImageView+BFAddition.h"

@implementation UIImageView (BFAddition)
...
+ (id)bf_imageViewWithImageArray:(NSArray *)imageArray duration:(NSTimeInterval)duration {
    ...
    UIImageView *imageView = [UIImageView bf_imageViewWithImageNamed:[imageArray objectAtIndex:0]];
