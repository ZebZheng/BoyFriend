...
{
    return [self bf_imageRotatedByDegrees:[UIImage bf_radiansToDegrees:radians]];
}
/**
 *  @brief  旋转图片
 *
...
- (UIImage *)bf_imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation([UIImage bf_degreesToRadians:degrees]);
    ...
    CGContextRotateCTM(bitmap, [UIImage bf_degreesToRadians:degrees]);
