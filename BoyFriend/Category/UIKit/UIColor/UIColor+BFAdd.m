...
#import "UIColor+BFAdd.h"
#import <objc/runtime.h>

@implementation UIColor (BFAdd)
...
+ (UIColor *)bf_hexStr:(NSString *)hexStr {
    return [UIColor bf_hexStr:hexStr alpha:1.0];
}
...
+ (nullable UIColor *)bf_gradientColorWithType:(BFGradientType)type colors:(NSArray<UIColor *> *)colors {
    return [UIColor bf_gradientColorWithType:type size:CGSizeMake(1, 1) colors:colors];
}
///渐变颜色
