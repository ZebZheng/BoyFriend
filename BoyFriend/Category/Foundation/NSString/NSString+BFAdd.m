...
#pragma make ------ 属性 ------
- (NSAttributedString *)bf_HTMLAttributedString {
    NSAttributedString *attributedString = [[NSAttributedString alloc] initWithData:[self dataUsingEncoding:NSUnicodeStringEncoding] options:@{ NSDocumentTypeDocumentAttribute: NSHTMLTextDocumentType,NSCharacterEncodingDocumentAttribute :@(NSUTF8StringEncoding)} documentAttributes:nil error:nil];
    return attributedString;
}

/** 首字母转换成小写 */
- (NSString *)bf_firstCharLower
{
...
- (NSDictionary * )bf_jsonConversionDictionary {
    if (self == nil) {
        return nil;
    }
